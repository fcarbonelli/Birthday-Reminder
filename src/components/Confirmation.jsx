    ...
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="container flex flex-col items-center px-4 py-12 mx-auto text-center">
                ...
                Email Confirmation  <span class="text-blue-500">Sent.</span>
                </h2>
                ...
                <div class="inline-flex w-full mt-6 sm:w-auto">
                    <a href="#" class="inline-flex items-center justify-center w-full px-6 py-2 text-white duration-300 bg-green-600 rounded-lg hover:bg-green-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80">
                        Log In
                    </a>
                </div>
            </div>
